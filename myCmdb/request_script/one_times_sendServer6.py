...
class SendServerData:
    def __init__(self,url,username,password,login_data):#直接把变量一股脑的传给类，下面的方法直接调用就好了
        self.url = url
    ...
    def user_check(self):
        ...
        try:
            ...
            self.sendServer() #获取token之后发送数据到服务器上面
...
if __name__ == '__main__':
    ...
    s = SendServerData(url,username,password,login_data)
    s.user_check()
